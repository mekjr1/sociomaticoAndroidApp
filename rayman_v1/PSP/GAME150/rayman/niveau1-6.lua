...
poingvie = Image.load ("png/poingvie.png")
texte = "HO une vie !"
...
if affichagevie == 1 then
screen:print (180,70,texte,violet)
end
...
if statut == "droite" then 
if colision == 0 then
if X<168 and X>130 and rayman.y>=210 then 
affichagevie = 0
end
end
end
