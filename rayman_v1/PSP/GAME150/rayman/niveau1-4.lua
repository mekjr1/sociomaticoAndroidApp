...
fondecranniveau = Image.load ("png/trou/petittroudroite.png")
...
texte = "inutile ici : appuie sur triangle pour voir au loin"
...
screen:print (35,70,texte,violet)
...
if statut == "droite" then
if colision==0 then
if X>340 and X<372 and rayman.y>=220 then
colision=1
dofile("niveau1-4.lua")
end
end
end
...
if statut == "gauche" then
if colision==0 then
if X>340 and X<368 and rayman.y>=220 then
colision=1
dofile("niveau1-4.lua")
end
end
...
if colision==0 then
if X>340 and X<360 and rayman.y>=220 then
colision=1
dofile("niveau1-4.lua")
end
end
...
if colision==0 then
if X>334 and X<372 and rayman.y>=220 then
colision=1
dofile("niveau1-4.lua")
end
end
...
if colision==0 then
if X>320 and X<354 and rayman.y>=220 then
colision=1
dofile("niveau1-4.lua")
end
end
