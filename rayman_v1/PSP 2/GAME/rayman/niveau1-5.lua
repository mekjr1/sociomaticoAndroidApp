...
fondecranniveau = Image.load ("png/trou/petittrougauche.png")
...
screen:print (160,70,texte,violet)
...
if statut == "droite" then
if colision==0 then
if X>32 and X<68 and rayman.y>=220 then
colision=1
...
if statut == "droite" then
if colision==2 then
if X>34 and X<68 and rayman.y>=220 then
colision=3
dofile("niveau1-5.lua")
end
end
...
if statut == "gauche" then
if colision==0 then
if X>28 and X<62 and rayman.y>=220 then
colision=1
dofile("niveau1-5.lua")
end
end
...
if colision==0 then
if X>20 and X<54 and rayman.y>=220 then
colision=1
dofile("niveau1-5.lua")
end
end
...
if colision==0 then
if X>32 and X<64 and rayman.y>=220 then
colision=1
dofile("niveau1-5.lua")
end
end
...
if colision==0 then
if X>32 and X<48 and rayman.y>=220 then
colision=1
dofile("niveau1-5.lua")
end
end
